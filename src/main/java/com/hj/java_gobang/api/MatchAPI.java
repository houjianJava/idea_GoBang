...
import com.hj.java_gobang.game.MatchRequest;
import com.hj.java_gobang.game.MatchResponse;
import com.hj.java_gobang.game.Matcher;
import com.hj.java_gobang.game.OnlineUserManager;
...
public class MatchAPI extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        //  此处的代码,之所以能够getAttributes,全靠在注册Websocket的时候
        //  加上的.addInterceptors(new HttpSessionHandshakeInterceptor())
        //  这个逻辑就把 HttpSession中的Attribute都给拿到WebSocketSession中了
        ...
        try {
            ...
            if (onlineUserManager.getFromGameHall(user.getUserId()) != null
                ...
                //此处直接关闭有些太激进了,还是返回一个特殊的message,供客户端来进行判定,由客户端负责进行处理
                //session.close();
                return;
            }
